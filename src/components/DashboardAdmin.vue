<template>
    <div class="dashboard">
        <v-navigation-drawer class="fullheight" width="256" permanent app fixed>
            <v-list-item>
                <v-list-item-content>
                    <v-list-item-title class="title">TravelKuy</v-list-item-title>
                </v-list-item-content>
            </v-list-item>
...
export default {
    ...
    data(){
        return{
            drawer:true,
            items:[
                {title: "Destination", to:"/admin/destination"},
                {title: "Ticket", to:"/admin/ticket"},
                {title: "Souvenirs", to:"/admin/souvenir"},
            ],
        };
    },
    methods:{
